const ARCANE_BUILD_ID = '2.1.1-visual-cache-fix';
import { Save } from './save.js?v=2.1.1';
import { Input } from './input.js?v=2.1.1';
import { UI } from './ui/menus.js?v=2.1.1';
import { AudioManager } from './audio.js?v=2.1.1';
...
(async () => {
  try {
    const { Game } = await import('./game.js?v=2.1.1');
...
console.info('VISUAL CACHE FIX ATIVO — build 2.1.1-visual-cache-fix');
