import { CHARACTERS, MAPS, META_UPGRADES, DIFFICULTIES, ACHIEVEMENTS } from '../config.js?v=2.2.0';
import { WEAPONS } from '../weapons/weaponData.js?v=2.2.0';
import { EVOLUTIONS, ARCANE_FUSIONS } from '../evolutions.js?v=2.2.0';
import { RELICS } from '../relics.js?v=2.2.0';
