...
{
  const fake={time:60};
  assert.equal(Game.prototype.boneArcherCap.call(fake),2);
  fake.time=360; assert.equal(Game.prototype.boneArcherCap.call(fake),4);
  fake.time=780; assert.equal(Game.prototype.boneArcherCap.call(fake),6);
  fake.time=1500; assert.equal(Game.prototype.boneArcherCap.call(fake),7);
}
