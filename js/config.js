...
export const CHARACTERS = {
  mage: {
    name: 'Mago', icon: '🧙', startWeapon: 'runeBarrage', passive: 'Laser Rúnico',
  ...
  archer: {
    name: 'Arqueiro', icon: '🏹', startWeapon: 'huntersVolley', passive: 'Chuva do Caçador',
  ...
  necromancer: {
    name: 'Necromante', icon: '💀', startWeapon: 'boneCovenant', passive: 'Exército dos Caídos',
  ...
  knight: {
    name: 'Cavaleiro Arcano', icon: '🛡️', startWeapon: 'arcaneBladeSignature', passive: 'Guarda Arcana',
  ...
  druid: {
    name: 'Druida', icon: '🌿', startWeapon: 'livingThorns', passive: 'Ira da Natureza',
  ...
  assassin: {
    name: 'Assassino', icon: '🥷', startWeapon: 'shadowKnivesSignature', passive: 'Passo Sombrio',
  ...
  ,warlock: {
    name: 'Warlock', icon: '📕', startWeapon: 'abyssalSigilSignature', passive: 'Pacto Sombrio',
    description: 'Maldições, explosões sombrias e controle de grupos marcados.', unlock: 'Mate 500 inimigos no total',
    base: { hp: 138, speed: 154, damage: 1.08, armor: 1, crit: .08, critDamage: 1.9, attackSpeed: 1, cooldown: .94, area: 1.08, projectileSpeed: 1, amount: 0, pickup: 95, xp: 1.02 }
  },
  paladin: {
    name: 'Paladino', icon: '☀️', startWeapon: 'sacredWaveSignature', passive: 'Julgamento Divino',
    description: 'Defesa, luz e golpes de área com barreiras temporárias.', unlock: 'Derrote um miniboss',
    base: { hp: 215, speed: 140, damage: 1.02, armor: 10, crit: .05, critDamage: 1.7, attackSpeed: .96, cooldown: 1.02, area: 1.12, projectileSpeed: 1, amount: 0, pickup: 86, xp: .98 }
  },
  elementalist: {
    name: 'Elementalista', icon: '🔷', startWeapon: 'primalCoreSignature', passive: 'Ciclo Elemental',
    description: 'Alterna fogo, gelo, raio e terra e acelera builds elementais.', unlock: 'Descubra 3 evoluções',
    base: { hp: 145, speed: 160, damage: 1.04, armor: 2, crit: .08, critDamage: 1.85, attackSpeed: 1.04, cooldown: .93, area: 1.08, projectileSpeed: 1.08, amount: 0, pickup: 98, xp: 1.04 }
  },
  battlemage: {
    name: 'Mago de Batalha', icon: '⚔️', startWeapon: 'arcaneGreatswordSignature', passive: 'Corte Arcano',
    description: 'Mistura alcance curto, feixes e proteção arcana em combate próximo.', unlock: 'Alcance nível 10',
    base: { hp: 178, speed: 150, damage: 1.07, armor: 5, crit: .07, critDamage: 1.8, attackSpeed: 1.06, cooldown: .96, area: 1.08, projectileSpeed: 1, amount: 0, pickup: 90, xp: 1 }
  },
  summoner: {
    name: 'Invocador', icon: '🪬', startWeapon: 'celestialLightSignature', passive: 'Familiar Ancestral',
    description: 'Entidades permanentes, familiares e pressão autônoma no campo.', unlock: 'Mate 1.500 inimigos no total',
    base: { hp: 148, speed: 156, damage: .98, armor: 2, crit: .06, critDamage: 1.8, attackSpeed: 1, cooldown: .96, area: 1.06, projectileSpeed: 1, amount: 1, pickup: 105, xp: 1.05 }
  },
  bloodMage: {
    name: 'Mago Sanguíneo', icon: '🩸', startWeapon: 'bloodLancesSignature', passive: 'Nova Sanguínea',
    description: 'Ondas rubras que escalam com vida máxima sem consumir HP automaticamente.', unlock: 'Sobreviva 10 minutos',
    base: { hp: 168, speed: 151, damage: 1.05, armor: 2, crit: .10, critDamage: 1.95, attackSpeed: .98, cooldown: .98, area: 1.1, projectileSpeed: 1, amount: 0, pickup: 92, xp: 1 }
  },
  monk: {
    name: 'Monge Arcano', icon: '🥋', startWeapon: 'kiFistsSignature', passive: 'Explosão de Ki',
    description: 'Combate móvel, ondas de energia e controle direcional de curta recarga.', unlock: 'Vença 1 partida',
    base: { hp: 160, speed: 184, damage: 1.01, armor: 3, crit: .12, critDamage: 1.9, attackSpeed: 1.16, cooldown: .95, area: 1, projectileSpeed: 1.12, amount: 0, pickup: 86, xp: 1 }
  },
  technomancer: {
    name: 'Tecnômante', icon: '⚙️', startWeapon: 'arcaneDronesSignature', passive: 'Drone Arcano',
    description: 'Tecnologia rúnica, drones e disparos automáticos de precisão.', unlock: 'Descubra 3 Arcane Fusions',
    base: { hp: 152, speed: 158, damage: 1.02, armor: 3, crit: .09, critDamage: 1.85, attackSpeed: 1.04, cooldown: .95, area: 1, projectileSpeed: 1.12, amount: 0, pickup: 96, xp: 1 }
  }
...
export const ENEMIES = {
  ...
  demon: {
    name: 'Demônio da Fenda', color: '#bd4f55', hp: 190, damage: 18, speed: 84, xp: 30,
    size: 25, visualSize: 25, hitboxRadius: 15.5, behavior: 'skirmisher', coin: .08, typeMult: 1.15
  },
  specter: {
    name: 'Espectro Arcano', color: '#8f7bd6', hp: 126, damage: 16, speed: 76, xp: 28,
    size: 24, visualSize: 24, hitboxRadius: 13.5, behavior: 'orbitChase', coin: .075, typeMult: 1.08
  },
  elite: {
  ...
  beastBoss: {
    ...
    coin: 18, boss: true, miniboss: true, typeMult: 2.7, fusionItem: 'bloodMoonShard'
  },
  graveTyrant: {
    name: 'GRAVE TYRANT', color: '#9a8c72', hp: 7200, damage: 29, speed: 48, xp: 600,
    size: 61, visualSize: 61, hitboxRadius: 39, behavior: 'bossSpecial', bossStyle: 'grave',
    projectileStyle: 'boneArrow', coin: 13, boss: true, typeMult: 2.45, fusionItem: 'necromancerCrown'
  },
  arcaneBehemoth: {
    name: 'ARCANE BEHEMOTH', color: '#a659cf', hp: 8300, damage: 31, speed: 50, xp: 650,
    size: 64, visualSize: 64, hitboxRadius: 41, behavior: 'bossSpecial', bossStyle: 'arcane',
    projectileStyle: 'titanRune', coin: 14, boss: true, typeMult: 2.55, fusionItems: ['titanCore','celestialFeather','arcaneGear','arcaneCrown']
  },
  plagueMother: {
    name: 'PLAGUE MOTHER', color: '#76a748', hp: 7800, damage: 28, speed: 45, xp: 640,
    size: 63, visualSize: 63, hitboxRadius: 40, behavior: 'bossSpecial', bossStyle: 'plague',
    projectileStyle: 'shadowShard', coin: 14, boss: true, typeMult: 2.5, fusionItem: 'soulLantern'
  },
  frostColossus: {
    name: 'FROST COLOSSUS', color: '#78cfe3', hp: 9200, damage: 33, speed: 43, xp: 700,
    size: 67, visualSize: 67, hitboxRadius: 44, behavior: 'bossSpecial', bossStyle: 'frost',
    projectileStyle: 'wardenShard', coin: 15, boss: true, typeMult: 2.65, fusionItems: ['frozenCore']
  },
  infernalWyrm: {
    name: 'INFERNAL WYRM', color: '#d95b3f', hp: 9000, damage: 35, speed: 68, xp: 720,
    size: 65, visualSize: 65, hitboxRadius: 39, behavior: 'bossSpecial', bossStyle: 'infernal',
    projectileStyle: 'beastSpine', coin: 16, boss: true, typeMult: 2.7, fusionItems: ['heartVolcano','solarFragment','dragonScale']
  },
  stormHerald: {
    name: 'STORM HERALD', color: '#e2cf58', hp: 8500, damage: 32, speed: 55, xp: 690,
    size: 59, visualSize: 59, hitboxRadius: 37, behavior: 'bossSpecial', bossStyle: 'storm',
    projectileStyle: 'titanRune', coin: 15, boss: true, typeMult: 2.6, fusionItems: ['stormCrystal']
  },
  titanRoots: {
    name: 'TITAN OF ROOTS', color: '#6fa24e', hp: 9800, damage: 34, speed: 39, xp: 740,
    size: 69, visualSize: 69, hitboxRadius: 45, behavior: 'bossSpecial', bossStyle: 'roots',
    projectileStyle: 'wardenShard', coin: 17, boss: true, typeMult: 2.75, fusionItems: ['ancientRoot','primalSeed']
  },
  voidReaper: {
    name: 'VOID REAPER', color: '#7653a8', hp: 8800, damage: 36, speed: 61, xp: 730,
    size: 60, visualSize: 60, hitboxRadius: 36, behavior: 'bossSpecial', bossStyle: 'void',
    projectileStyle: 'lichBolt', coin: 17, boss: true, typeMult: 2.72, fusionItems: ['voidFragment','abyssalEye','moonstone']
  },
  finalBoss: {
