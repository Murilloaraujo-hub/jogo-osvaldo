import { WEAPONS, getWeaponStats } from './weaponData.js';
...
export class WeaponSystem {
  ...
  fire(id, w, level, fromChaos = false) {
    ...
    switch (w.type) {
      ...
      case 'nova':
        ...
        g.burst(p.x, p.y, g.colorFor(w.element), 20);
  ...
  orbit(id, w, level, dt) {
    ...
    for (let i = 0; i < n; i++) {
      ...
      g.orbitVisuals.push({ x, y, r: 10 + Math.min(6, level), color: g.colorFor(w.element) });
    }
  }
