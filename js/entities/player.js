import { xpRequired } from '../config.js?v=2.2.0';
...
export class Player {
  ...
  update(input, dt, bounds, game = null) {
    ...
    this.x = Math.max(30, Math.min(bounds.w - 30, this.x + a.x * moveSpeed * dt));
    this.y = Math.max(30, Math.min(bounds.h - 30, this.y + a.y * moveSpeed * dt));
