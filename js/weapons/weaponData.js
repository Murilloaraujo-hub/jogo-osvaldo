...
export const WEAPONS = {
  ...
  elementalBolt: {
    name: 'Projétil Elemental', icon: '🔷', type: 'elementalCycle', role: 'PROJECTILE', element: 'arcane', max: 5,
    damage: 34, cooldown: .88, speed: 455, area: 28, pierce: 1, desc: 'Alterna fogo, gelo, raio e terra a cada disparo.',
  ...
  familiar: {
    name: 'Familiar', icon: '🦊', type: 'familiar', role: 'SUMMON', element: 'arcane', max: 5,
    damage: 26, cooldown: 1.0, area: 16, desc: 'Um familiar permanente orbita o jogador e dispara contra inimigos.',
    levels: lv('+25% dano', 'Dispara mais rápido', '+1 familiar', 'Projéteis perfuram', 'Familiar lança explosão rúnica')
  },
  bloodNova: {
  ...
  eidolonPrime: { name:'Eidolon Prime', icon:'🦊✦', type:'familiar', role:'SUMMON', element:'arcane', max:1, damage:78, cooldown:.48, area:26, evolved:true, rarity:'legendary', desc:'Familiar maior que lança rajadas e explosões rúnicas.' },
...
export function getWeaponStats(id, level = 1) {
  ...
  if (w.fusion) {
    ...
    s.cooldown = (w.cooldown || 1) * Math.max(.82, 1 - (l - 1) * .035);
    return s;
  }
