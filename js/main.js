const ARCANE_BUILD_ID = '2.4.0-navigation-hordes-classes';
import { Save } from './save.js?v=2.4.0';
import { Input } from './input.js?v=2.4.0';
import { UI } from './ui/menus.js?v=2.4.0';
import { AudioManager } from './audio.js?v=2.4.0';
...
(async () => {
  try {
    const { Game } = await import('./game.js?v=2.4.0');
    ...
    console.log('%cArcane Horder 2.4.0 carregado', 'color:#72e1bd;font-weight:bold');
  } catch (error) {
...
console.info('NAVIGATION + BIG HORDES + CLASS REDESIGN — build 2.4.0');
