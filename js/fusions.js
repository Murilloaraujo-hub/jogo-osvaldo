import { WEAPONS } from './weapons/weaponData.js?v=2.6.0';

export const FUSION_RECIPES = [
  { id: 'apocalypseRain', name: 'CHUVA DO APOCALIPSE', result: 'apocalypseRain', abilities: ['infernalSun', 'cataclysm'], replace: ['infernalSun', 'cataclysm'], fusion: true },
  ...
  { id: 'glacialComet', name: 'COMETA GLACIAL', result: 'glacialComet', abilities: ['absoluteZero', 'cataclysm'], replace: ['absoluteZero', 'cataclysm'], fusion: true },
  { id: 'undeadConductor', name: 'UNDEAD CONDUCTOR', result: 'undeadConductor', abilities: ['skeletonColossus', 'thunderLord'], replace: ['skeletonColossus', 'thunderLord'], fusion: true },
  ...
  { id: 'phantomBlades', name: 'LÂMINAS FANTASMAS', result: 'phantomBlades', abilities: ['voidFang', 'soulRequiem'], replace: ['voidFang', 'soulRequiem'], fusion: true },
  ...
  { id: 'arcaneSun', name: 'SOL ARCANO', result: 'arcaneSun', abilities: ['arcaneHalo', 'infernalSun'], replace: ['arcaneHalo', 'infernalSun'], fusion: true },
  ...
  { id: 'briarTempest', name: 'TEMPESTADE DE ESPINHOS', result: 'briarTempest', abilities: ['plagueGarden', 'galeReaper'], replace: ['plagueGarden', 'galeReaper'], fusion: true },
  ...
  { id: 'elementalSingularity', name: 'SINGULARIDADE ELEMENTAL', result: 'elementalSingularity', abilities: ['primalConvergence', 'arcaneHalo'], replace: ['primalConvergence', 'arcaneHalo'], fusion: true },
  ...
  { id: 'thunderFamiliar', name: 'FAMILIAR TROVEJANTE', result: 'thunderFamiliar', abilities: ['eidolonPrime', 'thunderLord'], replace: ['eidolonPrime', 'thunderLord'], fusion: true },
  { id: 'bloodRequiem', name: 'RÉQUIEM RUBRO', result: 'bloodRequiem', abilities: ['sanguineEclipse', 'soulRequiem'], replace: ['sanguineEclipse', 'soulRequiem'], fusion: true },
  ...
  { id: 'stormDroneSwarm', name: 'ENXAME RÚNICO', result: 'stormDroneSwarm', abilities: ['runicOverseer', 'thunderLord'], replace: ['runicOverseer', 'thunderLord'], fusion: true },
];

export function meetsFusion(player, recipe) {
  return recipe.abilities.every(id => (player.weapons[id] || 0) >= 1);
}
