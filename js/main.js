...
import { Save } from './save.js?v=2.8.0';
import { Input } from './input.js?v=2.8.0';
import { UI } from './ui/menus.js?v=2.8.0';
import { AudioManager } from './audio.js?v=2.8.0';
...
(async () => {
  try {
    const { Game } = await import('./game.js?v=2.8.0');
