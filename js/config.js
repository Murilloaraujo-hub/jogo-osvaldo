...
export const CHARACTERS = {
  mage: {
    ...
    base: { hp: 90, speed: 212, damage: 1.08, armor: 0, crit: .06, critDamage: 1.8, attackSpeed: 1, cooldown: .92, area: 1.08, projectileSpeed: 1, amount: 0, pickup: 95, xp: 1.04 }
  },
  archer: {
    ...
    base: { hp: 98, speed: 238, damage: 1, armor: 1, crit: .15, critDamage: 2, attackSpeed: 1.14, cooldown: 1, area: 1, projectileSpeed: 1.22, amount: 0, pickup: 88, xp: 1 }
  },
  necromancer: {
    ...
    base: { hp: 94, speed: 208, damage: .98, armor: 1, crit: .05, critDamage: 1.75, attackSpeed: 1, cooldown: .98, area: 1, projectileSpeed: 1, amount: 0, pickup: 105, xp: 1.05 }
  },
  knight: {
    ...
    base: { hp: 155, speed: 190, damage: 1.05, armor: 8, crit: .06, critDamage: 1.75, attackSpeed: 1, cooldown: 1.02, area: 1.08, projectileSpeed: 1, amount: 0, pickup: 82, xp: .98 }
  },
  druid: {
    ...
    base: { hp: 112, speed: 214, damage: 1, armor: 2, crit: .07, critDamage: 1.8, attackSpeed: 1.02, cooldown: .98, area: 1.12, projectileSpeed: 1, amount: 0, pickup: 100, xp: 1.03 }
  },
  assassin: {
    ...
    base: { hp: 82, speed: 270, damage: 1.02, armor: 0, crit: .2, critDamage: 2.15, attackSpeed: 1.22, cooldown: .96, area: .95, projectileSpeed: 1.18, amount: 0, pickup: 82, xp: 1 }
  }
};
