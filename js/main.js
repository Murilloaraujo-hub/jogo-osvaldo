const ARCANE_BUILD_ID = '2.6.0-arsenal-classes-hordes';
import { Save } from './save.js?v=2.6.0';
import { Input } from './input.js?v=2.6.0';
import { UI } from './ui/menus.js?v=2.6.0';
import { AudioManager } from './audio.js?v=2.6.0';
...
(async () => {
  try {
    const { Game } = await import('./game.js?v=2.6.0');
    ...
    console.log('%cArcane Horder 2.6.0 carregado', 'color:#72e1bd;font-weight:bold');
  } catch (error) {
...
console.info('FUSION COMPLETION PATCH — build 2.6.0');
