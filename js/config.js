...
export const CHARACTERS = {
  ...
  ,warlock: {
    name: 'Warlock', icon: '📕', startWeapon: 'curse', passive: 'Pacto Sombrio',
  ...
  paladin: {
    name: 'Paladino', icon: '☀️', startWeapon: 'holyBlade', passive: 'Julgamento Divino',
  ...
  elementalist: {
    name: 'Elementalista', icon: '🔷', startWeapon: 'elementalBolt', passive: 'Ciclo Elemental',
  ...
  battlemage: {
    name: 'Mago de Batalha', icon: '⚔️', startWeapon: 'arcaneSlash', passive: 'Corte Arcano',
  ...
  summoner: {
    name: 'Invocador', icon: '🪬', startWeapon: 'familiar', passive: 'Familiar Ancestral',
  ...
  bloodMage: {
    name: 'Mago Sanguíneo', icon: '🩸', startWeapon: 'bloodNova', passive: 'Nova Sanguínea',
  ...
  monk: {
    name: 'Monge Arcano', icon: '🥋', startWeapon: 'kiBurst', passive: 'Explosão de Ki',
  ...
  technomancer: {
    name: 'Tecnômante', icon: '⚙️', startWeapon: 'arcaneDrone', passive: 'Drone Arcano',
...
export const ENEMIES = {
  ...
  arcaneBehemoth: {
    ...
    projectileStyle: 'titanRune', coin: 14, boss: true, typeMult: 2.55, fusionItems: ['titanCore','celestialFeather']
  },
  plagueMother: {
  ...
  frostColossus: {
    ...
    projectileStyle: 'wardenShard', coin: 15, boss: true, typeMult: 2.65, fusionItem: 'frozenCore'
  },
  infernalWyrm: {
    ...
    projectileStyle: 'beastSpine', coin: 16, boss: true, typeMult: 2.7, fusionItem: 'heartVolcano'
  },
  stormHerald: {
    ...
    projectileStyle: 'titanRune', coin: 15, boss: true, typeMult: 2.6, fusionItem: 'stormCrystal'
  },
  titanRoots: {
    ...
    projectileStyle: 'wardenShard', coin: 17, boss: true, typeMult: 2.75, fusionItem: 'ancientRoot'
  },
  voidReaper: {
    ...
    projectileStyle: 'lichBolt', coin: 17, boss: true, typeMult: 2.72, fusionItem: 'voidFragment'
  },
  finalBoss: {
